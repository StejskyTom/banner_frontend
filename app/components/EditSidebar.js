  ...
  return (
    <aside className="w-80 bg-white border-l border-gray-200 text-gray-800 h-screen flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <label className="text-xs text-gray-600 mt-4 block">Mezera (px)</label>
        <Slider
          min={0}
          max={100}
          step={4}
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) => setCarousel({ ...carousel, pauseOnHover: e.target.checked })}
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
          <label htmlFor="pauseOnHover" className="text-sm text-gray-700 select-none cursor-pointer">
