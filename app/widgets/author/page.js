...
import { PencilSquareIcon, TrashIcon, PlusIcon, UserCircleIcon, EllipsisVerticalIcon, CodeBracketIcon, DocumentDuplicateIcon } from '@heroicons/react/24/solid';
...
export default function AuthorWidgetsPage() {
    ...
    const handleDuplicate = async (widget) => {
        try {
            const res = await authorizedFetch(`/author-widgets/${widget.id}/duplicate`, {
                method: 'POST'
            });
